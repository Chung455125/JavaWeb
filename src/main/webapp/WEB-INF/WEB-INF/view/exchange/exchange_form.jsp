...
<head>
	...
	<link rel="stylesheet" href="/JavaWeb/css/button-min.css">
</head>
<body background="/JavaWeb/image/watermark.webp" style="padding: 20px">
	<form class="pure-form" method="post" action="/JavaWeb/exchange">
		<fieldset>
			<legend>Exchange Form</legend>
			<select id="symbol" name="symbol">
				<option value="TWD" selected="selected">台幣 TWD</option>
